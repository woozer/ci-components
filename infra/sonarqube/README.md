...
De scanimage bevat Maven 3.9.12, Java 25, Node.js 24 en Python 3. De installer neemt [de centrale rapportagehelper](../../scripts/sonar_report.py) op als `/opt/ci/sonar_report.py`, publiceert de image in Artifactory en stelt `SONAR_CI_IMAGE` automatisch in. De buildcontext is de repositoryhoofdmap; de `.dockerignore` laat alleen de Dockerfile en de helper toe.
