...
- Record material accepted deviations and their reasons in the relevant documentation. See [reuse and standards](docs/reuse-and-standards.md). Keep the assessment proportional to the change; this agreement does not add a separate approval step for already authorized work.
